...
- `06_The Process` — 애플 공홈 TV+ 선반처럼 가운데 카드와 양옆 peek 입니다.
  하단 점이 알약으로 늘어나며 ~5초 동안 에너지 바가 차면 다음 장으로 넘어가고
  무한 반복합니다. 드래그·양옆 카드·점 클릭으로도 넘길 수 있고, 끄는 동안은
  바가 멈춥니다. 카드 1120 × 820, 모서리 22. 점 8px · 활성 알약 40px. 글자
  크기(66/28/23/32)는 시안 그대로이고, 납작해지는 scale 은 쓰지 않습니다.
