...
export const automatedCrm = {
  ...
  systems: [
    ...
    },
    {
      ...
      /** 모바일 시안 hu_automated_05_m · 본문 2줄 */
      bodyMobile: [
        "예약금 확인 시 '확정' 상태로 즉시 전환됩니다.",
        "취소와 노쇼 내역까지 한눈에 깔끔하게 분류합니다.",
      ],
    },
    {
      index: "SYSTEM 03",
      ...
      /** 모바일 시안 hu_automated_06_m · 본문 2줄 */
      bodyMobile: [
        "월간·주간 단위로 전체 일정을 확인합니다.",
        "디자이너별 휴무와 예약 현황도 쉽게 필터링합니다.",
      ],
    },
    {
      index: "SYSTEM 04",
      ...
      /** 모바일 시안 hu_automated_07_m · 본문 2줄 */
      bodyMobile: [
        "시술별 소요 시간과 예약금을 자유롭게 설정하고,",
        "디자이너별 차등 단가도 실시간 반영합니다.",
      ],
    },
  ],
} as const;
...
/*
 * 10_FAQ — PC 시안 hu_FAQ_PC (아코디언). 모바일도 동일 리스트를 축소 적용.
  ...
  list: [
    {
      ...
      answerMobile: [
        ...
        [
          ...
          { text: "- 자료 접수 완료 후 단독 웹 쇼룸 구축 및 카카오톡 AI\n매니저 연동" },
        ],
      ] satisfies FaqAnswerGroup[],
    },
    {
      ...
      answerMobile: [
        ...
        [
          { text: "직접 소통이나 사진 확인이 필요할 때는 별도 모드" },
          { text: "변경 없이 관리자 카카오톡 채널 채팅방에 참여하여" },
          { text: "고객과 직접 대화할 수 있습니다." },
        ],
      ] satisfies FaqAnswerGroup[],
    },
    {
    ...
    },
    {
      ...
      answerMobile: [
        [
          { text: "• 연간 결제 혜택", bold: true },
          { text: "1년 구독 결제 시 연 79만원(VAT 별도)으로" },
          { text: "이용할 수 있습니다. 매월 결제 시 연 948,000원으로," },
